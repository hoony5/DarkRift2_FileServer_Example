public class PartyCreator
{
    ...
    public void ProcessCreatePartyRequest(RequestCreateParty req, MessageReceivedEventArgs e)
    {
        ...
        DatabaseCenter.Instance.GetDb().PartyMap.AddOrUpdate(createdParty.Name, createdParty);
        DatabaseCenter.Instance.GetDb().UserHeaderMap.AddOrUpdate(createdParty.Leader.AccountID, createdParty.Leader);
